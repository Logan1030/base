...
import com.footing.website.modules.cms.service.FileTplService;
import com.footing.website.modules.cms.service.SiteService;
import com.footing.website.modules.cms.utils.TplUtils;
...
public class CategoryController extends BaseController {
	...
	public String updateSort(String[] ids, Integer[] sorts, RedirectAttributes redirectAttributes) {
    	...
    	for (int i = 0; i < len; i++) {
    		entitys[i] = categoryService.get(Long.valueOf(ids[i]));
