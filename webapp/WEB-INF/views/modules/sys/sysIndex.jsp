		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					<li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fns:jsGetVal('${fnc:getCurrentSiteId()}')}.html" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
